...
export default function SwiperSlider({ children, spaceBetween = 30, slidesPerView = 3, freeMode = false, pagination = { clickable: true } }) {
    ...
    return (
        <Swiper
            ...
            className="max-w-full lg:[slidesPerView=1]"
            breakpoints={{
